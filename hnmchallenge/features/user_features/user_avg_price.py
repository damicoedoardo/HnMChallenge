...
class AVG_PRICE(UserFeature):
    ...
    def _create_feature(self) -> pd.DataFrame:
        ...
        data_df= data_df.groupby(DEFAULT_USER_COL).mean()
        data_df=data_df[[DEFAULT_USER_COL,"price"]]
        data_df=data_df.drop_duplicates([DEFAULT_USER_COL])
...
if __name__ == "__main__":
    ...
    for kind in ["train", "full"]:
        feature = AVG_PRICE(dataset, kind)
