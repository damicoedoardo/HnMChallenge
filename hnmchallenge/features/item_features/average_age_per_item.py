...
class AverageAgeItem(ItemFeature):
    FEATURE_NAME = "average_age_item"
    ...
    def _create_feature(self) -> pd.DataFrame:
        ...
        age = self.dataset.get_customers_df()[[DEFAULT_USER_COL, "age"]]
        merged_age = pd.merge(data_df, age, on=DEFAULT_USER_COL)
