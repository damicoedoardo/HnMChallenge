...
class PopSales1(ItemFeature):
    ...
    def _create_feature(self) -> pd.DataFrame:
        ...
        no_dup_data_df = no_dup_data_df[no_dup_data_df["sales_channel_id"] == 1]
        ...
        #     columns={"t_dat": "popularity_multiple_buy_sales_channel_1"}
        # )
        # # normalisation popularity
        # feature["popularity_multiple_buy_sales_channel_1"] = (
        #     feature["popularity_multiple_buy_sales_channel_1"]
        #     - feature["popularity_multiple_buy_sales_channel_1"].min()
        # ) / (
        #     feature["popularity_multiple_buy_sales_channel_1"].max()
        #     - feature["popularity_multiple_buy_sales_channel_1"].min()
        # )
