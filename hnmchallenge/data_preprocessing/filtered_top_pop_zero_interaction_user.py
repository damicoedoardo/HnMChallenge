...
if __name__ == "__main__":
    dr = DataReader()
    zero_int_users = dr.get_filtered_zero_interatction_users()
    ...
    _, item_map_dict = dr.get_filtered_new_raw_mapping_dict()
    ...
    zero_int_users.to_feather(
        dr.get_preprocessed_data_path() / "filtered_zero_interactions_recs.feather"
    )
