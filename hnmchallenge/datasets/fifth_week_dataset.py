...
class FifthWeekDataset(DatasetInterface):

    DATASET_NAME = "FifthWeekDataset"
    _ARTICLES_NUM = 104_547
    _CUSTOMERS_NUM = 1_362_281

    HOLDOUT_START_DATE = "2020-08-10"
    HOLDOUT_END_DATE = "2020-08-17"

    EVALUATION_START_DATE = "2020-09-15"

    TRAIN_CANDIDATE_DATE = "2020-07-10"
    FULL_CANDIDATE_DATE = "2020-07-17"
    ...
    def get_evaluation_data(self) -> pd.DataFrame:
        fd = super(FifthWeekDataset, self).get_full_data()
