...
class AILMLD4WDataset(DatasetInterface):

    DATASET_NAME = "AILMLD4W_dataset"
    ...
    def create_holdin_holdout(self) -> None:
        ...
        hold_in2 = fd[(fd["t_dat"] <= "2020-08-24")]
        intervals = [("2020-08-25", "2020-09-01")]
