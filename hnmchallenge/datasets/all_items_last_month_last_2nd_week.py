...
class AILML2WDataset(DatasetInterface):

    DATASET_NAME = "AILML2W_dataset"
    ...
    def create_holdin_holdout(self) -> None:
        ...
        # )
        # hold_out = fd.loc[m]
        hold_out = fd[(fd["t_dat"] >= "2020-09-09") & (fd["t_dat"] <= "2020-09-15")]
        # save holdin holdout
    ...
    def create_candidate_items(self) -> None:
        ...
        candidate_items = full_data[(full_data["t_dat"] >= "2020-09-02")][
            ["article_id"]
        ].drop_duplicates()
    ...
    def get_full_data(self) -> pd.DataFrame:
        ...
        fd = fd[fd["t_dat"] <= "2020-09-15"]
        return fd


if __name__ == "__main__":
    dataset = AILML2WDataset()
