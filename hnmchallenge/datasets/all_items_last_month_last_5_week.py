...
class AILML5WDataset(DatasetInterface):
    ...
    def create_holdin_holdout(self) -> None:
        ...
        hold_in = fd[(fd["t_dat"] <= "2020-08-18")]
        hold_out = fd[(fd["t_dat"] > "2020-08-18") & (fd["t_dat"] <= "2020-08-25")]
    ...
    def create_candidate_items(self) -> None:
        ...
        candidate_items = full_data[full_data["t_dat"] >= "2020-07-18"][
            ["article_id"]
        ].drop_duplicates()
