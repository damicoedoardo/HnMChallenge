...
class AILMLD3WDataset(DatasetInterface):

    DATASET_NAME = "AILMLD3W_dataset"
    ...
    def create_candidate_items(self) -> None:
        ...
        candidate_items = full_data[full_data["t_dat"] >= "2020-08-01"][["article_id"]]
