...
class SecondWeekDataset(DatasetInterface):

    DATASET_NAME = "SecondWeekDataset"
    _ARTICLES_NUM = 104_547
    _CUSTOMERS_NUM = 1_362_281

    HOLDOUT_START_DATE = "2020-09-01"
    HOLDOUT_END_DATE = "2020-09-08"

    EVALUATION_START_DATE = "2020-09-15"

    TRAIN_CANDIDATE_DATE = "2020-08-01"
    FULL_CANDIDATE_DATE = "2020-08-08"
    ...
    def get_evaluation_data(self) -> pd.DataFrame:
        fd = super(SecondWeekDataset, self).get_full_data()
